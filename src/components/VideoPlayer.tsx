...
const VideoPlayer: React.FC<VideoPlayerProps> = ({
  ...
  const currentVideoSource = video.videoUrl || video.thumbnail;
  const currentVideoPoster = video.thumbnail;
      ...
      <div className="flex flex-col lg:flex-row gap-8 px-6 max-w-7xl mx-auto">
        ...
        <div className="flex-1">
          ...
          >
            ...
            <div className={`absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent transition-all duration-300 ${showControls ? 'opacity-100' : 'opacity-0'
              }`}>
              {/* Center Play Button */}
              {!isPlaying && (
                        ...
                        <div className="absolute bottom-12 right-0 glass rounded-xl shadow-2xl w-56 py-3 border border-primary/20 bounce-in">
                          ...
                          {[0.25, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2].map((rate) => (
                            <button
                              ...
                              className={`w-full text-left px-4 py-2 hover:bg-primary/20 text-sm transition-all duration-300 ripple ${playbackRate === rate ? 'text-primary bg-primary/10' : 'text-text-primary'
                                }`}
                            >
                          ...
                          {['Auto', '1080p', '720p', '480p', '360p'].map((q) => (
                            <button
                              ...
                              className={`w-full text-left px-4 py-2 hover:bg-primary/20 text-sm transition-all duration-300 ripple ${quality === q.toLowerCase() ? 'text-primary bg-primary/10' : 'text-text-primary'
                                }`}
                            >
                              {q}
                            </button>
          ...
          <div className="mb-6 slide-in-left">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
              ...
              <div className="flex items-center space-x-3">
                <button
                  onClick={handleLike}
                  className={`flex items-center space-x-2 px-6 py-3 glass hover:bg-primary/20 rounded-xl transition-all duration-300 btn-animate ripple ${isLiked ? 'text-primary bg-primary/10' : ''
                    }`}
                >
                ...
                <button
                  ...
                  className={`flex items-center space-x-2 px-6 py-3 glass hover:bg-primary/20 rounded-xl transition-all duration-300 btn-animate ripple ${isDisliked ? 'text-red-400 bg-red-400/10' : ''
                    }`}
                >
                ...
                <button
                  onClick={handleSave}
                  className={`flex items-center space-x-2 px-6 py-3 glass hover:bg-primary/20 rounded-xl transition-all duration-300 btn-animate ripple ${isSaved ? 'text-secondary bg-secondary/10' : ''
                    }`}
                >
            ...
            <div className="flex items-start justify-between mb-4">
              ...
              <div className="flex items-center space-x-3">
                <button
                  ...
                  className={`flex items-center space-x-2 px-6 py-3 rounded-xl font-semibold transition-all duration-300 btn-animate ripple ${isSubscribed
            ...
            <div className="space-y-6">
              <div className="flex space-x-4 stagger-item">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-text-secondary mb-3 leading-relaxed">Great video!</p>
                  <div className="flex items-center space-x-6">
              ...
              <div className="flex space-x-4 stagger-item">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-text-secondary mb-3 leading-relaxed">Amazing content! The future of content is here.</p>
                  <div className="flex items-center space-x-6">
                    <button className="flex items-center space-x-2 text-text-muted hover:text-primary transition-all duration-300 scale-hover">
                      <ThumbsUp size={16} />
              ...
              <div className="space-y-3">
                {investmentTiers.map((tier, index) => {
                  ...
                  return (
                    <div
                      key={tier.name}
                      className={`border rounded-xl p-4 cursor-pointer transition-all duration-300 stagger-item card-hover ${selectedInvestmentTier === tier.name
